		...
		<section class="menu navbar-default menu05">
			...
			<nav class="navbar-collapse bs-navbar-collapse collapse"
				...
				<ul class="nav navbar-nav">
					<li class="bt-azul act-azul"><a href="svlPresidencial">PRESIDENCIAL</a>
					</li>
			...
			<div class="row">
				<div class="col-xs-12 col-md-3">
					<div class="menu-interna">
						<ul>
							<li><a href="svlPresidencial" class="act-izq">RESUMEN
									GENERAL</a></li>
							<li><a href="svlPresidenciales?id=pre">RESULTADOS
									PRESIDENCIALES</a></li>
							<li><a href="svlPresidenciales?id=tipo">RESULTADOS POR
									TIPO DE VOTOS</a></li>
						</ul>
					</div>
				</div>
									...
									<tbody>
										...
										<tr>
											<td><img width="40px" height="40px"
												src="images/simbolo_pkk.jpg" class="spaceimg"> <img
												width="40px" height="40px" src="images/pkk.jpg"
												class="spaceimg">PERUANOS POR EL KAMBIO</td>
											<td><%=data[0]%></td>
											<td><%= data[2] %></td>
										</tr>
										<tr>
											<td><img width="40px" height="40px"
												src="images/keyko.jpg" class="spaceimg"><img
												width="40px" height="40px" src="images/simbolo_keyko.jpg"
												class="spaceimg">FUERZA POPULAR</td>
											<td><%= data[1] %></td>
											<td><%= data[3] %></td>
										</tr>
									</tbody>
